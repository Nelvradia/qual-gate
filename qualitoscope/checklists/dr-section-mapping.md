...
| S5 Security | `security-tomographe` (I09) | `ai-ml-tomographe` (I12) | AI threats from I12 supplement S5 |
...
| S12 Licensing | `compliance-tomographe` (I05) | — | License compat, export control |
